...
\graphicspath{{/home/vipul/REPOSITORIES/cap/notes/figures/}
...
Then it puts some sanity constrains so that duration do not exceed [1,9] seconds. Use -L flag for manual source duration length.
\begin{verbatim}
  $dura = 1 if $dura < 1;
  $dura = 9 if $dura > 9;
\end{verbatim}
...
\begin{enumerate}
\item Not using the proper parameterization for moment tensor inversion \citep{TapeTape2012a_beach}. 
...
\en
But since this is just an ad-hoc function, using an inverse tangetial makes things look more complicated.
\end{minipage}
}
...
\caption{Source duration vs magnitude realtion used in CAP (red) and by GCMT (green).}
\end{figure}
...
\begin{tabular}{ccc}
%(a) A  & (b) B \\
\includegraphics[width=5.5cm]{20151124212557376_scak_020_beach_X1.eps} &
\includegraphics[width=5.5cm]{20151124212557376_scak_020_beach_X2.eps} &
\includegraphics[width=5.5cm]{20151124212557376_scak_020_beach_X3.eps} \\
\includegraphics[width=5.5cm]{20151124212557376_scak_020_beach_X4.eps} &
\includegraphics[width=5.5cm]{20151124212557376_scak_020_beach_X5.eps} &
\includegraphics[width=5.5cm]{20151124212557376_scak_020_beach_X6.eps} \\
\includegraphics[width=5.5cm]{20151124212557376_scak_020_beach_X7.eps} &
\includegraphics[width=5.5cm]{20151124212557376_scak_020_beach_X8.eps} &
\includegraphics[width=5.5cm]{20151124212557376_scak_020_beach_X9.eps} \\
\end{tabular} 
\begin{figure}
\caption{
