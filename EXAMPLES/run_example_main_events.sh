...
cap.pl -H0.01 -P0.58/1/30 -p0.67 -S0.05/2.0/0 -T1.5/60 -D1/1/0.5 -C2/10/0.25/0.5 -F0.0 -L0.1 -W1 -Y1 -Mutuhalf_4 -m2.8 -Zw_utuhalf_P01_V10_R01_S10.dat 20100516063454464 -I13/35/73/18/37 
