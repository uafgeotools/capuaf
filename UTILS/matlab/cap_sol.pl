...
print CSH "psmeca $J $R -Sm4.5c -G150/150/150 -L1p/0/0/0 -N $X $Y -K -O -V >>$psfile<<EOF\n0 0 $edep 0.0910 -0.0920 0.0010 0.0170 0.0160 0.0290 20 0 0\nEOF\n";
#print CSH "psxy $pxsfile $J $R -Sc1p -G0/0/255 -K -O -V>>$psfile\n";
#print CSH "psxy $txsfile $J $R -Sc1p -G255/0/0 -K -O -V>>$psfile\n";
print CSH "psxy $J $R -Sc5p -W1p/0/0/0 -G255/255/255 -K -N -O -V>>$psfile<<EOF\n$pxs $pys\nEOF\n";
print CSH "psxy $J $R -Sc5p -W1p/0/0/0 -G255/255/255 -K -N -O -V>>$psfile<<EOF\n$txs $tys\nEOF\n";
