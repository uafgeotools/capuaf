...
int regularGridvec(float xmin, float xmax, int dx, float *pArray);
int regularGridvecISO(float xmin, float xmax, int dx, float *pArray);
int regularGridvecDIP(float xmin, float xmax, int dx, float *pArray);
